        ...
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          ...
          <label className="flex items-center gap-2 text-xs uppercase tracking-[0.14em] text-slate-400">
            ...
            <select
              ...
              className="rounded-lg border border-slate-700 bg-slate-950 px-2.5 py-2 text-xs normal-case tracking-normal text-slate-200 outline-none focus:border-teal-400"
